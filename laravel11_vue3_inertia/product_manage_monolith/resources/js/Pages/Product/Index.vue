                ...
                <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-6">
                    <div class="space-x-3">
                        <button
                            ...
                            "
                            :class="{
                                'bg-red-300 cursor-not-allowed': !selectedIds.length,
                        ...
                        <button
                            ...
                            "
                            :class="{
                                'bg-cyan-300 cursor-not-allowed': !selectedIds.length,
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="
                                block p-2 ps-10 text-sm
                                text-gray-900 border
                                border-gray-300 rounded-lg w-80
